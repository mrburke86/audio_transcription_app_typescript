...
export type ChatUserMessageParam = OpenAI.Chat.Completions.ChatCompletionUserMessageParam;
export type ChatSystemMessageParam = OpenAI.Chat.Completions.ChatCompletionSystemMessageParam;
