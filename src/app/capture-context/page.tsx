...
export default function CaptureContextPage() {
    ...
    const handleInterviewStart = useCallback(async (newContext: InitialInterviewContext) => {
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="mt-8 text-center text-sm text-slate-500 dark:text-slate-400">
                    <p>
                        Your interview configuration will be saved for this session and used to provide 
                        personalized AI assistance and strategic intelligence.
                    </p>
                </div>
            </div>
        </div>
