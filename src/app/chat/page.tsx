...
export default function ChatPage() {
    ...
    renderCount.current++;
    console.log(`🧮 [DIAG] Chat Page rendered ${renderCount.current} times`);
    ...
    useEffect(() => {
        useBoundStore.persist.rehydrate(); // ✅ Manual hydration here        console.log('[DIAG-Hydrate] ChatPage hydrated on client');
        console.trace('[DIAG-Hydrate] Hydration stack trace');
    }, []);
...
//         isStreamingComplete,
//         llmLoading,
//         llmService, // NOT IN NEW
//         llmError, // NOT IN NEW
//         resetStreamedContent, // NOT IN NEW

//         // Chat State
//         conversationHistory,
//         addUserMessage,
//         clearHistory, // NOT IN NEW
//         getMessageCount, // NOT IN NEW
