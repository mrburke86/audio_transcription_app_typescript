 ...
 */
export const getNextLogicalRoute = (hasValidContext: boolean, currentRoute: AppRoute | null): AppRoute => {
 ...
 */
export const safeNavigateTo = (targetRoute: AppRoute, hasValidContext: boolean, allowBypass = false): void => {
