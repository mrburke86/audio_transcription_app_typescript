...
const RoleDescriptionModal: React.FC<RoleDescriptionModalProps> = ({
    ...
    useEffect(() => {
        try {
            ...
            logger.error(
                `❌ Error during RoleDescriptionModal mount: ${
    ...
    const validateInput = (value: string): boolean => {
        try {
            ...
            if (trimmed === "") {
                ...
                logger.warning(
                    "⚠️ User attempted to submit empty role description",
                );
                return false;
            }
            ...
            if (trimmed.length < 10) {
                ...
                logger.warning(
                    "⚠️ User attempted to submit role description that's too short",
                );
                return false;
            }
            ...
            if (trimmed.length > 1000) {
                ...
                logger.warning(
                    "⚠️ User attempted to submit role description that's too long",
                );
                return false;
            }
    ...
    const handleSubmit = () => {
        try {
            ...
            logger.info(
                `✅ Role description submitted: "${trimmedInput.substring(
                    0,
                    50,
            ...
            logger.error(
                `❌ Error submitting role description: ${
                    error instanceof Error ? error.message : "Unknown error"
                }`,
            );
    ...
    try {
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            This helps define how the AI should behave and
                            respond.
                        </DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-500 text-xs">
                            {inputValue.length}/1000 characters | Tip: Press
        ...
        logger.error(
            `❌ Critical error rendering RoleDescriptionModal: ${
                error instanceof Error ? error.message : "Unknown error"
            }`,
        );
        return (
            <Dialog open={true}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Unable to display role description modal
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
                        <Button
                            onClick={() =>
                                onSubmit("You are a helpful assistant.")
                            }
                        >
                            Use Default
                        </Button>
