...
//     {
//         name: 'gpt-4o',
//         description: 'Most advanced multimodal model with strong vision capabilities. Faster and cheaper than GPT-4 Turbo.',
...
//         description: 'Earlier version of GPT-4o model with a May 2024 knowledge cutoff.',
//         inputPricePerMillion: 5.0,
//         outputPricePerMillion: 15.0,
//         batchInputPricePerMillion: 2.5,
//         batchOutputPricePerMillion: 7.5,
...
//     {
//         name: 'gpt-4o-mini',
//         description: 'Cost-efficient small model with vision capabilities. Cheaper and smarter than GPT-3.5 Turbo.',
...
//         description: 'Mini version of GPT-4o with a knowledge cutoff of July 2024.',
//         inputPricePerMillion: 0.15,
//         outputPricePerMillion: 0.6,
//         batchInputPricePerMillion: 0.075,
//         batchOutputPricePerMillion: 0.3,
...
//     {
//         name: 'o1-preview',
//         description: 'New reasoning model for complex tasks with an October 2023 knowledge cutoff.',
...
//         description: 'Small embedding model for search, clustering, topic modeling, and classification.',
...
//         description: 'Fine-tuning available with complimentary tokens until October 31, 2024.',
...
//     {
//         name: 'DALL·E 2',
//         description: 'Cost-efficient image generation model optimized for lower cost.',
//         inputPricePerMillion: 0.02,
//         outputPricePerMillion: 0.02,
//     },
// ];
...
// export type OpenAIModelName = (typeof OpenAIModelNames)[keyof typeof OpenAIModelNames];

// export function isOpenAIModel(name: string): name is OpenAIModelName {
//     return Object.values(OpenAIModelNames).includes(name as OpenAIModelName);
// }
